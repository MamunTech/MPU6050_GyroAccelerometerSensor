...
*/
//float b=abs(angle_pitch_buffer)/1000+(abs(angle_pitch_buffer)/100)%10+(abs(angle_pitch_buffer)/10)%10+abs(angle_pitch_buffer)%10;
float b=(angle_pitch_buffer)/1000+((angle_pitch_buffer)/100)%10+((angle_pitch_buffer)/10)%10+(angle_pitch_buffer)%10;
...
*/
 // float a=abs(angle_roll_buffer)/1000+(abs(angle_roll_buffer)/100)%10+(abs(angle_roll_buffer)/10)%10+abs(angle_roll_buffer)%10;
    float a=(angle_roll_buffer)/1000+((angle_roll_buffer)/100)%10+((angle_roll_buffer)/10)%10+(angle_roll_buffer)%10;
